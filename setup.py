...
setup(
    ...
    packages=find_packages(exclude=["tests.*", "tests"]), # Include all packages except test
    author='Youness',
    author_email='X@eY.Z',
    ...
    install_requires=open('requirements.txt').readlines(),  # Reads dependencies from file
